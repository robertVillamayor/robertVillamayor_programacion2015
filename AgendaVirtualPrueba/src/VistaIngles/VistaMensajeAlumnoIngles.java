...
public class VistaMensajeAlumnoIngles extends JPanel {
		...
		private JLabel[] labelDestinatario = new JLabel[15];
		private JLabel[] labelAsunto = new JLabel[labelDestinatario.length];
		private JLabel[] labelFecha = new JLabel[labelDestinatario.length];
		private JLabel[] imagenBotonBorrar = new JLabel[labelDestinatario.length];
		...
		private void crearImagenBotonBorrar(){
			...
			for (int i=0;i<imagenBotonBorrar.length;i++){
				...
				imagenBotonBorrar[i].setIcon(new ImageIcon(VistaMensajeAlumnoIngles.class.getResource("/images/Borrar.png")));
	 ...
	 * Create the panel.
	 */
	public VistaMensajeAlumnoIngles (FrameMedianoIngles vistamediana) {
		setLayout(null);
		...
		fondo = new JLabel("");
		fondo.setIcon(new ImageIcon(VistaMensajeAlumnoIngles.class.getResource("/images/FONDO VISTAS5.png")));
