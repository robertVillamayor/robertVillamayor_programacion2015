...
public class VistaCalendarioIngles extends JPanel {
...
private JTabbedPane tabbedPane;
	...
	private JLabel lema,lblNewLabel;
	private JLabel lblNewLabel_1,lblNewLabel_2;
	private JDayChooser dayChooser;
	/**
	 * Create the panel.
	 */
	public VistaCalendarioIngles() {
		...
		tabbedPane.addTab("DAY", null, panel_dia, null);
		...
		tarea_1 = new JCheckBox("Spanish: Exercises Page. 30");
		...
		tarea_2 = new JCheckBox("History: Read page 34 ");
		...
		tarea_3 = new JCheckBox("Buy green card");
		...
		evento_1 = new JCheckBox("Continents work");
		...
		evento_2 = new JCheckBox("English oral exam");
		...
		lblNewLabel.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/fondoCalendario.png")));
		...
		tabbedPane.addTab("WEEK", null, panel_semana, null);
		...
		panel_1.add(lunes);
		lunes.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/lunes.png")));
		
		lblTareas_1 = new JLabel("Tasks");
		...
		lblEventos_1 = new JLabel("Events");
		...
		label_Lun.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/cajadia1.png")));
		...
		panel_2.add(martes);
		martes.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/martes.png")));
		
		label_Mar = new JLabel("");
		label_Mar.setBounds(0, 0, 190, 166);
		panel_2.add(label_Mar);
		label_Mar.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/cajadia1.png")));
		...
		miercoles.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/miercoles.png")));
		
		label_Mier = new JLabel("");
		label_Mier.setBounds(0, 0, 190, 166);
		panel_3.add(label_Mier);
		label_Mier.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/cajadia1.png")));
		...
		panel_4.add(jueves);
		jueves.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/jueves.png")));
		
		label_Jue = new JLabel("");
		label_Jue.setBounds(0, 0, 190, 200);
		panel_4.add(label_Jue);
		label_Jue.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/cajadia1.png")));
		...
		panel_5.add(viernes);
		viernes.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/viernes.png")));
		
		label_Vie = new JLabel("");
		label_Vie.setBounds(0, 0, 190, 200);
		panel_5.add(label_Vie);
		label_Vie.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/cajadia1.png")));
		...
		panel_6.add(sabado);
		sabado.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/sabad.png")));
		
		label_Sab = new JLabel("");
		label_Sab.setBounds(0, 0, 190, 167);
		panel_6.add(label_Sab);
		label_Sab.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/cajadia1.png")));		
		...
		panel_7.add(domingo);
		domingo.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/domingo.png")));
		
		label_Dom = new JLabel("");
		label_Dom.setBounds(0, 0, 190, 166);
		panel_7.add(label_Dom);
		label_Dom.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/cajadia1.png")));
		
		lema = new JLabel("");
		lema.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/lemarecto.png")));
		lema.setBounds(0, 205, 194, 121);
		panel_semana.add(lema);
		
		lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/fondoCalendario.png")));
		...
		tabbedPane.addTab("MOUNTH", null, dayChooser, null);
		dayChooser.setLayout(null);
		
		
		lblNewLabel_2 = new JLabel("New label");
		lblNewLabel_2.setIcon(new ImageIcon(VistaCalendarioIngles.class.getResource("/images/fondoCalendario.png")));
