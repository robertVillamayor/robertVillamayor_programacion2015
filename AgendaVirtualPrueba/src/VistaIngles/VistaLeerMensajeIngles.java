...
public class VistaLeerMensajeIngles extends JPanel {
	 ...
	 * Create the panel.
	 */
	public VistaLeerMensajeIngles (FrameMedianoIngles vistamediana) {
		setLayout(null);
		...
		fondo = new JLabel("");
		fondo.setIcon(new ImageIcon(VistaLeerMensajeIngles.class.getResource("/images/FONDO VISTAS5.png")));
