...
public class VistaMensajeProfesorIngles extends JPanel{

	public static FrameMedianoIngles vistamediana;
	...
	private void crearImagenBotonBorrar(){
		...
		for (int i=0;i<imagenBotonBorrar.length;i++){
			...
			imagenBotonBorrar[i].setIcon(new ImageIcon(VistaMensajeProfesorIngles.class.getResource("/images/Borrar.png")));
	 ...
	 * Create the panel.
	 */
	public VistaMensajeProfesorIngles(FrameMedianoIngles vistaMediana) {
		setLayout(null);
		...
		fondo = new JLabel("");
		fondo.setIcon(new ImageIcon(VistaMensajeProfesorIngles.class.getResource("/images/FONDO VISTAS5.png")));
